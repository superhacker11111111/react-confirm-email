...
//
import { userConfig } from '../nav/config-navigation';
...
function Searchbar() {
  ...
  const reduceItems = userConfig.map((list) => handleLoop(list.items, list.subheader)).flat();
