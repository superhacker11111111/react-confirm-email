...
import { getProducts, deleteProduct, deleteProducts } from '../../redux/slices/product';
// routes
...
export default function EcommerceProductListPage() {
  ...
  const handleDeleteRows = (selectedRows) => {
    dispatch(deleteProducts(selectedRows, SnackBar));
  };
  ...
  return (
    <>
      <Helmet>
        <title> Ecommerce: Product List | RealityFence</title>
      </Helmet>
