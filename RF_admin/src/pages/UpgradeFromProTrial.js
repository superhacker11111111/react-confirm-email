...
function PaymentForm() {
  ...
  const { updatePaymentInfo } = useSelector((state) => state.user);
  ...
  useEffect(() => {
    ...
    setCustomPrice(updatePaymentInfo);
  }, [updatePaymentInfo]);
              ...
              <Stack spacing={1.5}>
                ...
                <Stack direction="row" alignItems="center" justifyContent="space-between">
                  ...
                  <Typography variant="h6">
                    {fCurrency(!paymentType ? customPrice : Number(customPrice) * 12)}*
                  </Typography>
                </Stack>
                {paymentType && price && price.price !== '0' ? (
                  <Stack direction="row" justifyContent="end">
                    <Label color="success">
                      Saving {fCurrency((Number(price?.price) - Number(customPrice)) * 12)} A Year
                    </Label>
                  </Stack>
                ) : (
                  ''
